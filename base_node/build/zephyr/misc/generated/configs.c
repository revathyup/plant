...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_SENSOR_NODE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_NODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_NODE_INIT_PRIORITY, 90);
